...
const RegisterPage = () => {
    ...
    return (<div style={{'display': 'grid', 'justifyContent': 'center'}}>
        ...
        <div className="container">
            <h5>Введите email</h5><input name='email' type="text" onChange={getEmail}/>
        ...
        <div className="container mt-2">
            <h5>Придумайте пароль</h5><input name='password' type="text" onChange={getPassword}/>
        </div>
        <div className="container">
            <h5>Повторите пароль</h5><input name='confirmPass' type="text" onChange={getConfirmPass}/>
        </div>
